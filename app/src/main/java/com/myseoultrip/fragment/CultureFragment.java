...
public class CultureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.search_nearby_place_culture_recycler_view);
        ...
        tourApiClient.getLocationList(TourApiService.SERVICE_KEY, TourApiService.MOBILE_OS, TourApiService.MOBILE_App, TourApiService.MY_TYPE, 30, 1, "P", 78, mapX, mapY, 4000, new ApiCallback<LocalListModelItems>() {
            @Override
